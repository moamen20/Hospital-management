...
public class Reception_gui extends javax.swing.JFrame  {
    Connection con=null;
    ResultSet rs=null;
...
private void getdata()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reception_gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
