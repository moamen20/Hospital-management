...
public class Patientedit_gui extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
    ...
    private void Reset()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patientedit_gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Patientedit_gui().setVisible(true);
            }
        });
    }
