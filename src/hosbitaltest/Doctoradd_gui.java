...
public class Doctoradd_gui extends javax.swing.JFrame {
Connection con=null;
ResultSet rs=null;
    ...
    private void Reset()
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Doctoradd_gui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Doctoradd_gui().setVisible(true);
            }
        });
    }
